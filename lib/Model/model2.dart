...
class Welcome {
    ...
    factory Welcome.fromJson(Map<String, dynamic> json) => new Welcome(
        flights: new List<Flight>.from(json["flights"].map((x) => Flight.fromJson(x))),
...
class Flight {
    ...
    factory Flight.fromJson(Map<String, dynamic> json) => new Flight(
        ...
        codeshares: json["codeshares"] == null ? null : Codeshares.fromJson(json["codeshares"]),
        ...
        actualOffBlockTime: json["actualOffBlockTime"] == null ? null : json["actualOffBlockTime"],
        publicFlightState: PublicFlightState.fromJson(json["publicFlightState"]),
        ...
        checkinAllocations: json["checkinAllocations"] == null ? null : CheckinAllocations.fromJson(json["checkinAllocations"]),
        transferPositions: json["transferPositions"] == null ? null : TransferPositions.fromJson(json["transferPositions"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "actualOffBlockTime": actualOffBlockTime == null ? null : actualOffBlockTime,
        ...
        "checkinAllocations": checkinAllocations == null ? null : checkinAllocations.toJson(),
        "transferPositions": transferPositions == null ? null : transferPositions.toJson(),
...
class CheckinAllocations {
    ...
    factory CheckinAllocations.fromJson(Map<String, dynamic> json) => new CheckinAllocations(
        checkinAllocations: new List<CheckinAllocation>.from(json["checkinAllocations"].map((x) => CheckinAllocation.fromJson(x))),
        remarks: json["remarks"],
    );

    Map<String, dynamic> toJson() => {
        "checkinAllocations": new List<dynamic>.from(checkinAllocations.map((x) => x.toJson())),
        "remarks": remarks,
    };
}
...
class CheckinAllocation {
    ...
    factory CheckinAllocation.fromJson(Map<String, dynamic> json) => new CheckinAllocation(
...
enum Description { EMPTY, ECONOMY_CLASS, BAGGAGE_DROP_OFF, SKY_PRIORITY, BUSINESS_CLASS, CHECK_IN, SERVICE_BALIE }
...
class PublicFlightState {
    ...
    factory PublicFlightState.fromJson(Map<String, dynamic> json) => new PublicFlightState(
        flightStates: new List<FlightState>.from(json["flightStates"].map((x) => flightStateValues.map[x])),
    );

    Map<String, dynamic> toJson() => {
        "flightStates": new List<dynamic>.from(flightStates.map((x) => flightStateValues.reverse[x])),
    };
}
...
class TransferPositions {
    ...
    factory TransferPositions.fromJson(Map<String, dynamic> json) => new TransferPositions(
        transferPositions: new List<int>.from(json["transferPositions"].map((x) => x)),
    );

    Map<String, dynamic> toJson() => {
        "transferPositions": new List<dynamic>.from(transferPositions.map((x) => x)),
    };
}
