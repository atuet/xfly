          ...
          builder:  (context, snapshot){
            ...
            else if (snapshot.hasData)
            {
              ...
              return new ListView(
                ...
                children: flights.map((flights)=> GestureDetector(
                  onTap: (){
                    // Plus tard
                  },
                  child: Card(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child : Text('${(heure(flights.scheduleTime))}',
                                  style: TextStyle(
                                    fontSize: 28.0,
                              ...
                              Container(
                                margin: const EdgeInsets.only(left: 15.0),
                                child : Text('${(flights.route.destinations).toString().substring(1, 4)}', 
                                  style: TextStyle(
                                    fontSize: 15.0,
                                    color: Color.fromRGBO(59, 59, 61, 1)
                                    ),
                          ...
                          child: Column(
                            children: <Widget>[ 
                              ...
                              Container(
                                    ...
                                    child : Center(
                                      child : Text('${(estimation(flights.estimatedLandingTime, flights.actualLandingTime, flights.actualOffBlockTime))}', 
                                      style: TextStyle(
                                        fontSize: 15.0,
                                        color: Color.fromRGBO(59, 59, 61, 1)
                                        ),
